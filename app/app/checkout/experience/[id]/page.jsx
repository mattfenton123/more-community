...
export default function ExperienceCheckout() {
  ...
  if (!exp) {
    return (
      <div style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--slate-950)', color: 'var(--white)' }}>
  ...
  return (
    <div style={{ minHeight: '100dvh', background: 'var(--slate-950)', color: 'var(--white)', position: 'relative' }}>
