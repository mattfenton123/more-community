                    ...
                    <div key={u.id} style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '12px', overflow: 'hidden' }}>
                      ...
                      {isExpanded && (
                        <div style={{ borderTop: '1px solid rgba(255,255,255,0.04)', padding: '14px' }}>
                          ...
                          {/* Actions */}
                          <div style={{ display: 'flex', gap: '6px' }}>
                            <button onClick={(e) => { e.stopPropagation(); navigate.push(`/profile/${u.id}`); }} className="btn btn-outline interactive-press" style={{ flex: 1, padding: '8px', borderRadius: '8px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
                              <Eye size={12} /> View Profile
                            </button>
                            <button onClick={(e) => { e.stopPropagation(); navigate.push(`/chat/dm/${u.id}`); }} className="btn btn-primary interactive-press" style={{ flex: 1, padding: '8px', borderRadius: '8px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px', background: 'var(--teal-500)', border: 'none' }}>
