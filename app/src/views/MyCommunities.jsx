...
import { SkeletonList, SkeletonCommunityCard } from '../components/SkeletonCard';
        ...
        {isLoading ? (
          ...
          <div style={{ textAlign: 'center', padding: '40px 20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
              <button onClick={() => navigate.push('/discover')} className="btn btn-primary" style={{ display: 'inline-flex', padding: '12px 24px', borderRadius: '99px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '16px' }}>
            {joined.map((comm, i) => (
              <div 
                key={comm.id}
                onClick={() => navigate.push(`/community/${comm.id}`)}
